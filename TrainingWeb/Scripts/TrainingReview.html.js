...
angular.module('trainingReview.directive', []).directive('starRating', function () {
    ...
    return {
        ...
        template: ['<div>',
            '<img ng-src="{{rating > 0 ? \'/images/star-gold32.png\'  : \'/images/star-white32.png\'}}" />',
            '<img ng-src="{{rating > 1 ? \'/images/star-gold32.png\'  : \'/images/star-white32.png\'}}" />',
            '<img ng-src="{{rating > 2 ? \'/images/star-gold32.png\'  : \'/images/star-white32.png\'}}" />',
            '<img ng-src="{{rating > 3 ? \'/images/star-gold32.png\'  : \'/images/star-white32.png\'}}" />',
            '<img ng-src="{{rating > 4 ? \'/images/star-gold32.png\'  : \'/images/star-white32.png\'}}" />'].join(''),
        link: function (scope, element, attrs, transclusion) {
            ...
            if (isEditable) {
                ...
                $('img', element).mouseover(function () {
                    ...
                    scope.$root.$digest();
                    img.nextAll().attr('src', 'images/star-white32.png');
                    img.prevAll().attr('src', 'images/star-gold32.png');
                    img.attr('src', 'images/star-gold32.png');
                });
            }
        }
    };
...
var trainingController = function ($scope, training, employeetraining, user) {
    $scope.training = training.retrieve(1);
    $scope.user = user.retrieve();
    $scope.training.EmployeeTrainings = employeetraining.retrieve(1);
